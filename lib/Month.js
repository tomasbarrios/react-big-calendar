...
var MonthView = _react2.default.createClass({
  ...
  _dates: function _dates(row) {
    ...
    return row.map(function (day, colIdx) {
      ...
      var dayProps = _this6._getDayProps(_this6.props.dayPropGetter, row, colIdx);
      return _react2.default.createElement(
        'div',
        {
          key: 'header_' + colIdx,
        ...
        _react2.default.createElement(
          'a',
          { href: '#', onClick: _this6._dateClick.bind(null, day), className: 'rbc-date-cell-day' },
          _localizer2.default.format(day, _this6.props.dateFormat, _this6.props.culture)
        ),
        _react2.default.createElement(
          'p',
          { key: 'date-cell-day-header_' + colIdx,
            className: 'rbc-date-cell-header' },
          dayProps.header
        ),
        _react2.default.createElement(
          'p',
          { key: 'date-cell-day-description_' + colIdx,
            className: 'rbc-date-cell-description' },
          dayProps.description
        )
      );
    });
  },
  _getDayProps: function _getDayProps(dayPropGetter, row, i) {
    if (dayPropGetter) {
