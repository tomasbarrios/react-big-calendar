...
var DisplayCells = function (_React$Component) {
  ...
  DisplayCells.prototype.render = function render() {
    ...
    for (var i = 0; i < slots; i++) {
      ...
      children.push(this.renderDay(i, selecting, startIdx, endIdx, dayProps));
    }
  ...
  DisplayCells.prototype.renderDay = function renderDay(i, selecting, startIdx, endIdx, dayProps) {
    return _react2.default.createElement('div', { key: 'bg_' + i,
  ...
  DisplayCells.prototype._getDayProps = function _getDayProps(dayPropGetter, row, i, slots) {
    if (dayPropGetter) {
      var dayProps = dayPropGetter(row[i]);
      var style = (0, _eventLevels.segStyle)(1, slots);
  ...
  DisplayCells.prototype._updateDayLayout = function _updateDayLayout(dayProps, style) {
    if (!dayProps.style) dayProps.style = {};
